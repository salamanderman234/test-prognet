                ...
                <div class="container w-75 p-5" style="font-size: 15px;">
                    ...
                    <form action="{{ route('admin.autenticate') }}" method="post">
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control @error('username') is-invalid @enderror @if($errors->any()){{'is-invalid'}}@endif" id="username" aria-describedby="emailHelp" name="username">
                        </div>
                        <div class="mb-3">
                            <div class="row">
                                <div class="col-3">
                        ...
                        <div class="container text-center">
                            <a href="{{ route('admin.signup')}}" class="tambahan text-center">Register Admin (test)</a>
                        </div>
                      </form>
                </div>
            </div>
