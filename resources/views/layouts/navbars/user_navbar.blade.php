            ...
            <div class="row">
                ...
                <div class="col-md-2 col-sm-2 flex-nowrap pt-2" style=" padding-left: 0px !important;">
                    <div class="container-fluid d-flex align-items-center justify-content-end h-100 p-0">
                        @if (auth()->check())
                            <a href="">
                                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cart-fill {{ count(auth()->user()->unreadNotifications)<=0 ?'me-3':'' }}" viewBox="0 0 16 16">
                                    <path d="M0 1.5A.5.5 0 0 1 .5 1H2a.5.5 0 0 1 .485.379L2.89 3H14.5a.5.5 0 0 1 .491.592l-1.5 8A.5.5 0 0 1 13 12H4a.5.5 0 0 1-.491-.408L2.01 3.607 1.61 2H.5a.5.5 0 0 1-.5-.5zM5 12a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm7 0a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm-7 1a1 1 0 1 1 0 2 1 1 0 0 1 0-2zm7 0a1 1 0 1 1 0 2 1 1 0 0 1 0-2z"/>
                                </svg>
                            </a>
                            @if (count(auth()->user()->unreadNotifications)>0)
                                <span class="badge badge-notify-cart rounded-circle">{{count(auth()->user()->unreadNotifications)}}</span>
                            @endif
