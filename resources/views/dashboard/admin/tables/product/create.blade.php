                    ...
                    <div class="header-body">
                        <form action="{{route('admin.table.product.save')}}" method="POST" enctype="multipart/form-data">
                            <div class="row d-flex ">
                                <div class="col-4">
                                    <div class="container rounded bg-light px-3 pt-3 pb-3">
                                        ...
                                        <div class="container p-0">
                                            ...
                                            <textarea class="form-control" name="description" id="description" style="height: 48.2%; width:100%;"></textarea>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-4">
                                    <div class="container rounded bg-light p-3">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" id="namprice">
                                        </div>
                                        <div class="mb-3">
                                ...
                                <div class="col-4">
                                    <div class="container rounded bg-light p-3 image-section" style="max-height: 428px;">
                                        <div class="mb-4 d-flex justify-content-center">
                                        ...
                                        <div class="mb-2 d-flex justify-content-center p-0">
                                            <span>Thumbnail</span>
                                        </div>
                                        <hr class="mt-1 ">
